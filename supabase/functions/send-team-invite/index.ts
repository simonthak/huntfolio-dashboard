      ...
      body: JSON.stringify({
        ...
        html: `
          <div>
            ...
            <a href="https://app.antlers.dev/join-team?code=${inviteCode}" style="display: inline-block; background-color: #13B67F; color: white; padding: 12px 24px; text-decoration: none; border-radius: 4px; margin-top: 16px;">
              Gå med i laget
            </a>
          </div>
        `,
